        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm">
              Your premier destination for event tickets. Find and book tickets for concerts, sports,
              theater, and more.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300">
              Your one-stop platform for browsing and booking event tickets.
            </p>
          </div>
>>>>>>> origin/main
          <div>
...
=======
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>Email: info@eventicketing.com</li>
